...
class mod_forum_post_form extends moodleform {
    ...
    function definition() {
        ...
        if (groups_get_activity_groupmode($cm, $course)) { // hack alert
            ...
            $contextcheck = has_capability('moodle/site:accessallgroups', $modulecontext) && 
                    has_capability('mod/forum:movediscussions', $modulecontext) && empty($post->parent) && $groupcount > 1;
            if ($contextcheck) {
