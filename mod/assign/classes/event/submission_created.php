 ...
 *
 *     @type int submissionid ID number of this submission.
 *     @type int submissionattempt Number of attempts made on this submission.
 *     @type string submissionstatus Status of the submission.
 *     @type int groupid The group ID if this is a teamsubmission (optional).
 * }
 *
 * @package    mod_assign
 * @copyright  2014 Adrian Greeve <adrian@moodle.com>
