...
define(['jquery', 'core/templates', 'core/fragment'], function($, templates, fragment) {
    ...
    var load_student = function(assignid, rownum, studentid, contextid) {
        var params = {id: assignid, rownum: rownum, studentid: studentid};

        $.when(fragment.fragmentAppend('mod_assign', "gradepage", contextid, params, '#add-action-here', '#page')).then(function() {
            ...
            $('#nextstudent').click(function() {
                ...
                load_student(assignid, rownum, studentid, contextid);
            });
        });
    };
    ...
    return {
        ...
        init: function(assignid, rownum, contextid) {
