...
$string['configfullnamedisplay'] = 'This defines how names are shown when they are displayed in full. For most mono-lingual sites the most efficient setting is "{$a->firstname} {$a->lastname}", but you may choose to hide surnames altogether, or to leave it up to the current language pack to decide (some languages have different conventions). Placeholders that can be used are: {$a->firstname}, {$a->lastname}, {$a->firstnamephonetic}, {$a->lastnamephonetic}, {$a->middlename}, {$a->alternatename}, and language. If the setting is left blank then the language pack will be used.';
...
$string['firstnamephonetic'] = 'firstnamephonetic';
...
$string['lastnamephonetic'] = 'lastnamephonetic';
