...
$string['deletecategoryerrornonempty'] = 'Cannot delete category which contains courses or sub-categories. To delete this category you should manually delete all sub-categories and courses.';
$string['deletecategoryerrorhasquestions'] = 'Cannot delete this category, because it contains some questions. You may create a new course in this category to move or delete these questions.';
...
$string['resortsubcategoriesbyname'] = 'Re-sort sub-categories by name';
