...
$string['legacylogstoreinuse'] = 'This site currently has the legacy log store enabled. This log store is now deprecated. Please use a different log store such as "standard" or "external".';
