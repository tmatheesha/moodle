...
$string['configfailedbackupcheck'] = 'Backup files located in the temp backup directory will be deleted if they are older than the specified time.';
...
$string['failedbackupcheck'] = 'Failed backup cleanup';
