...
class core_upgradelib_testcase extends advanced_testcase {
    ...
    public function test_upgrade_course_letter_boundary() {
        ...
        for ($i = 0; $i < 25; $i++) {
            ...
            if (in_array($i, array(2, 5, 10, 13, 14, 19, 23))) {
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[3]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[6]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[11]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[15]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[16]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[18]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[20]->id});
        // [21] A grade item with display settings which are not letters. Grade total will be affected so should be frozen.
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[21]->id});
        // [22] A grade item with display settings of letters which are default.
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[22]->id});
        ...
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[23]->id});
        // [24] A grade item with display settings of letters which are not default, which will be affected.
        $this->assertEquals(20160509, $CFG->{'gradebook_calculations_freeze_' . $courses[24]->id});
    }
