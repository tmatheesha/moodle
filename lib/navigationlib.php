...
class global_navigation extends navigation_node {
    ...
    public function __construct(moodle_page $page) {
        ...
        // Use the parents constuctor.... good good reuse
     ...
     *
     * @todo 2.2 (MDL-31025) $activities should always be an array and we should no longer 
     *             check for it being a course_modinfo object.
     *
     * @param navigation_node $sectionnode
     * @param int $sectionnumber
     * @param object $activities
     * @param course_modinfo $modinfo Object returned from {@see get_fast_modinfo()}
     * @return array An array of activity nodes
     */
