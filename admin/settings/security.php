...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('sitefullnameformat', new lang_string('fullnameformat', 'admin'), new lang_string('fullnameformatdisplay', 'admin'), 'Language file', PARAM_RAW, 50));
