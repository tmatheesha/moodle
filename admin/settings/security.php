...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('sitedisplaynameformat', new lang_string('displaynameformat', 'admin'), new lang_string('displaynameformat_desc', 'admin'), '', PARAM_TEXT, 50));
