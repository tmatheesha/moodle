@core @core_grades @aids
Feature: We can set the number of decimal points to round to and have it round up.
  ...
  Background:
    ...
    And the following "users" exist:
      ...
      | teacher1 | Teacher | 1 | teacher1@example.com | Terry   |
      | student1 | Student | 1 | student1@example.com | Sally   |
  ...
  Scenario: Students grades are rounded according to decimal setting in each grade book report.
    ...
    Then the following should exist in the "gradereport_history" table:
      ...
      | Student 1          | calc item                     | 25            |           |
      | Student 1          | Test assignment name          | 50            | Teacher 1 |
    ...
    And the field "Grade for Test assignment name" matches value "50"
    And the field "Grade for calc item" matches value "25"
    ...
    And the field "Grade for Sally (Student) 1" matches value "50"
    And I select "calc item" from the "Select grade item..." singleselect
    And the field "Grade for Sally (Student) 1" matches value "25"
  ...
  Scenario: Course completion with a course grade is shown as expected.
    ...
    Then the following should exist in the "criteriastatus" table:
      | -1-          | -3- | -4- | -5- |
      | Course grade | 55  | 55  | No  |
    And I log out
    And I log in as "student1"
    And I follow "Course 1"
    And I should see "55 (55 required)"