...
$string['singleviewperpage'] = 'Records per page';
$string['singleviewperpage_help'] = 'This setting determines the number of records displayed per page in the single view report.';
