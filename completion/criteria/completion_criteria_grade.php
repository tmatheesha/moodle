...
class completion_criteria_grade extends completion_criteria {
    ...
    public function get_status($completion) {
        ...
        if ($grade) {
            $grade = grade_round_value($grade, $decimalpoints);
        } else {
    ...
    public function get_details($completion) {
        ...
        $details['status'] = '';
        $details['requirement'] = grade_round_value($this->gradepass, $decimalpoints);
        $grade = grade_round_value($this->get_grade($completion), $decimalpoints);
