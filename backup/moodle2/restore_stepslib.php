...
class restore_gradebook_structure_step extends restore_structure_step {
    ...
    protected function gradebook_calculation_freeze() {
        ...
        // Courses from before 3.1 (20160509) may have a letter boundary problem and should be checked for this issue.
        if (!$gradebookcalculationsfreeze && $backupbuild < 20160509) {
            require_once($CFG->libdir . '/db/upgradelib.php');
