...
class restore_gradebook_structure_step extends restore_structure_step {
    ...
    protected function gradebook_calculation_freeze() {
        ...
        // Courses from before 3.1 (20160516 to be more specific) may have a letter boundary problem and should be checked for this issue.
        // Backups from before and including 2.9 could have a build number that is greater than 20160516 and should
        // be checked for this problem.
        if (!$gradebookcalculationsfreeze && ($backupbuild < 20160516 || $backuprelease <= 2.9)) {
            require_once($CFG->libdir . '/db/upgradelib.php');
